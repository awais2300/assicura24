		...
		<div class="container my-4">
			...
			<div style="width:100%;padding:10px;margin:auto;text-align:center">
				<a class="btn btn-primary" href="<?= base_url(); ?>Home" style="background-color:#885ead; width:600px;color:white" id="newOffer"><b>Click here for new Offer!</b></a>
			</div>
			...
			<div id="table_div" style="padding:60px">
						...
						<tbody>
							...
							foreach ($request_data as $data) { ?>
								<tr>
									...
									<td scope="row">
										<a class="btn btn-default" style="background-color:#885ead;color:white;font-weight:600" href="<?= base_url(); ?>User_Login/dashboard/<?= $data['request_no']; ?>" id="contractView<?php echo $count ?>">View Contract </a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
				...
				<?php } else { ?>
					<a style="font-style:bold; font-weight:600;font-family:Arial, Helvetica, sans-serif"> There are no contracts issued yet. </a>
				<?php } ?>
			</div>
		</div>
