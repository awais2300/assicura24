...
<div style="width:600px; background:#333; margin:0 auto;">
    ...
    <div style="background-color:#fff">
        <p style="padding:25px 25px 5px; margin:0; text-align:left; line-height:30px; font-size:16px; font-family: 'Open Sans', sans-serif; font-weight:600; text-decoration:none ">Dear <?= $name ?>, </p>



    <pre style="padding:0 25px 5px; margin:0; text-align:left; line-height:20px; font-size:12px; font-family: 'Open Sans', sans-serif; text-decoration:none; color: #333;"> 
    Your request for update forgot password has been recieved, Click on the button below to reset your credentials. 
		
    </pre>

        <div class="button" style="margin-bottom: 30px; margin-top: 20px; padding: 0px 25px 0px; text-align:center"> <a href="<?php echo base_url().'User_Login/resetPassword/'.$id?>" style="padding:7px 30px;color: #fff;text-decoration: none; background-color:#e72d2e; border-radius:50px; font-family: 'Open Sans', sans-serif; font-size:12px"> Reset Password </a> </div>
       ...
       <div style="background:#333; padding:12px 0">
           ...
           <!-- <div style="text-align:center; margin-top:13px; border-top:1px solid #fff; border-bottom:1px solid #fff; padding:4px 0px;    margin-left: 60px;margin-right: 60px;">
            ...
            <div class="footer-copyright" style="color:#FFF;margin-top: 10px;margin-bottom: -30px; text-align:center; height:50px;   font-family: 'Open Sans', sans-serif; font-size:10px;">
                <i class="fa fa-copyright" aria-hidden="true"></i>Copyrights © Artabz Technologies Pvt. Ltd. 2020. All Rights Reserved.
            </div>
