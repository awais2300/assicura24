...
<div style="width:600px; background:#333; margin:0 auto;">
    ...
    <div style="background-color:#fff">
        ...
        <pre style="padding:0 25px 5px; margin:0; text-align:left; line-height:20px; font-size:12px; font-family: 'Open Sans', sans-serif; text-decoration:none;    color: #333;"> A new request to suspend offer has been recieved by
