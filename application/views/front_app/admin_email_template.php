...
<h1 style="color:white;text-align:center;padding:15px">Assicura24</h1>
    ...
    <div style="background-color:#fff">
        ...
        <pre style="padding:0 25px 5px; margin:0; text-align:left; line-height:20px; font-size:12px; font-family: 'Open Sans', sans-serif; text-decoration:none;    color: #333;"> A new request to quote insurance offer has been recieved by
<?= $user_data['name'] ?> of his/her <?= $request_data['car_type']?> with plate no <?= $request_data['Plate_no'] ?>.
</pre>

        <div class="button" style="margin-bottom: 30px; margin-top: 20px; padding: 0px 25px 0px; text-align:center"> <a href="<?php echo base_url().'Admin/request_detail/'.$request_data['request_no']?>" style="padding:7px 30px;color: #fff;text-decoration: none; background-color:#e72d2e; border-radius:50px; font-family: 'Open Sans', sans-serif; font-size:12px"> Verify Request </a> </div>
